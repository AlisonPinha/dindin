import type { DbTransaction, DbTransactionType, DbOwnershipType, DbTransactionOrigin } from "@/lib/supabase"
...
export const mockTransacaoEntrada: DbTransaction = {
  ...
  origem: "manual" as DbTransactionOrigin,
  fatura_referencia: null,
  matched_transacao_id: null,
